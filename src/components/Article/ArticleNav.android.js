        ...
        <View style={[styles.actionsContainer,{backgroundColor:theme.colors.titleBar}]}>
          <TouchableElement onPress={()=>{this.props.onNavigate({type:'pop'})}}>
            <View style={styles.actionItem}>
              <Image
                ...
                source={require('../Common/image/ic_back_white.png')}
                resizeMode='contain' />
            </View>
          </TouchableElement>
          <View style={{flex: 1}} />
          <TouchableElement onPress={this._onPressShareButton}>
            <View style={styles.actionItem}>
              <Image
                ...
                source={require('../Common/image/ic_share_white.png')}
                resizeMode='contain' />
            </View>
          </TouchableElement>
          <TouchableElement onPress={this._onPressCollectButton}>
            <View style={styles.actionItem}>
              <Image
                style={styles.actionIcon}
                source={require('../Common/image/ic_collect_white.png')}
              resizeMode='contain' />
            </View>
          </TouchableElement>
          <TouchableElement onPress={this._onPressCommentButton}>
            <View style={styles.actionItem}>
              <Image
                ...
                source={require('../Common/image/ic_comment_white.png')}
                resizeMode='contain' />
          ...
          <TouchableElement onPress={this._onPressPraiseButton}>
            <View style={styles.actionItem}>
              <Image
                style={styles.actionIconWithCount}
                source={require('../Common/image/ic_praise_white.png')}
                resizeMode='contain' />
              <Text style={styles.count}>
                {extra.popularity}
              </Text>
